...
def serialize_drawing_for_workspace(
    ...
    return {
        ...
        "indexStatus": getattr(drawing, "index_status", "pending"),
        "indexError": getattr(drawing, "index_error", None),
        "scaleJson": getattr(drawing, "scale_json", None),
        "indexStatsJson": getattr(drawing, "index_stats_json", None),
